      ...
      <v-col cols="12" md="8">
        <base-material-card>
          <template v-slot:heading>
            <div class="display-2 font-weight-light">Edit Device</div>

            <div class="subtitle-1 font-weight-light">Complete your Device</div>
          </template>
          ...
          <v-form>
            <v-container class="py-0">
              <v-row>
                ...
                <v-col cols="12" md="4">
                  <v-text-field label="Name (Node)" class="purple-input" v-model="name" />
                </v-col>

                <v-col cols="12" md="6">
                  <v-text-field label="Contact Name" class="purple-input" v-model="contact_name" />
                </v-col>
                ...
                <v-col cols="12" md="4">
                  <v-text-field label="Longitude" class="purple-input" v-model="long" />
                </v-col>

                <v-col cols="12" md="4">
                  <v-text-field label="Latitude" class="purple-input" v-model="lat" />
                </v-col>

                <v-col cols="12" md="4">
                  <v-text-field class="purple-input" label="Status" type="number" v-model="status" />
                </v-col>
                ...
                <v-col cols="12" class="text-right">
                  <v-btn color="success" class="mr-0" @click="postDevice">ADD DEVICE</v-btn>
                </v-col>
              </v-row>
